...
Deno.test(
  {
    name: "Action: addItem - requirements and effects",
    sanitizeResources: false,
    sanitizeOps: false,
  },
  async (t) => {
...
Deno.test(
  {
    name: "Action: removeItem - requirements and effects",
    sanitizeResources: false,
    sanitizeOps: false,
  },
  async (t) => {
    ...
    try {
      ...
      await t.step(
        ...
        async () => {
          ...
          console.log(
            `Effect confirmed: Item ${itemId1} removed from wishlist.`
          );
...
Deno.test(
  {
    name: "Action: update* methods - requirements and effects",
    sanitizeResources: false,
    sanitizeOps: false,
  },
  async (t) => {
    ...
    try {
      ...
      await t.step(
        "Effect: Successfully updates isFutureApprove.",
        async () => {
          ...
          const updateResult =
            await itemCollectionConcept.updateIsFutureApprove({
              owner: userA,
              item: itemId,
...
Deno.test(
  {
    name: "Action: setPurchased - requirements and effects",
    sanitizeResources: false,
    sanitizeOps: false,
  },
  async (t) => {
...
Deno.test(
  {
    name: "Action: getAIInsight - requirements and effects",
    sanitizeResources: false,
    sanitizeOps: false,
  },
  async (t) => {
...
Deno.test(
  {
    name: "Query: _getWishListItems - requirements and effects",
    sanitizeResources: false,
    sanitizeOps: false,
  },
  async (t) => {
    ...
    try {
      ...
      await t.step(
        ...
        async () => {
          ...
          console.log(
            "Effect confirmed: All wishlist items returned correctly."
          );
        }
      );
    } finally {
...
Deno.test(
  {
    name: "Query: _getItemDetails - requirements and effects",
    sanitizeResources: false,
    sanitizeOps: false,
  },
  async (t) => {
    ...
    try {
      ...
      await t.step(
        ...
        async () => {
          ...
          const itemIdSet = (result as unknown as [{ itemIdSet: ID[] }])[0]
            .itemIdSet;
